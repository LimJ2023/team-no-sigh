...
<body>
    ...
    <main>
        ...
        <div class="account">
            ...
            <br/>
            <button><a href="input_data" style="text-decoration-line: none;">비밀번호 변경</a></button> <br/>
            <br>
            계정 삭제 <br/>
            <br/>
            ...
            <br/>
            <li>
                즐겨찾기 목록 등 개인 편의를 위해 저장한 모든 데이터가 영구적으로 삭제됩니다.
            </li>
            <li>이용중인 모든 유료서비스가 해지되며 결제한 금액은 환불되지 않습니다.</li> <br/>
            <button value="submit"><a href="account_delete" style="text-decoration-line: none;">계정 삭제</a></button>
        </div>
    </main>
</body>
</html>