                ...
                <div class="board-view-div">
                    <table class="table board-view-table">
                        <tr class="table board-view-table-info board-view-table-info-tr">
                            ...
                            <td class="board-view-table-info info-no"><c:out value="${data.board_num}"/></td>
                            <td class="board-view-table-info info-author info-author-1">작성자</td>
                            <td class="board-view-table-info info-author info-author-2"><c:out value="${data.user_id}"/></td>
                        
                            <td class="board-view-table-info info-date"><c:out value="${data.board_date}"/></td>
                            <td class="board-view-table-info info-clicks">조회수</td>
                            <td class="board-view-table-info info-clicks"><c:out value="${data.view_count}"/></td>
                        </tr>
