...
<body>
	...
	<div class="nav container">
		...
		<!-- navbar (각각 달아줘야함)-->
		<div class="navbar">
			<a href="home" class="nav-link nav-active"> <i class='bx bx-home'></i>
			...
			</a> <a href="admin" class="nav-link"> <i class='bx bx-wrench'></i> <span
				class="nav-link-title">관리자페이지 진입 버튼1</span>
			</a>
		</div>
	</div>
	</header>
			...
			<div class="footerCol">
				...
				<div class="linkIcons">
					...
					<a href="#"><img src="img/logo/instagram_logo_black.png"
						...
						src="img/logo/email_logo_black.png" class="footerIcon emailLogo"></a>
				</div>
			</div>
		</div>
	</div>
