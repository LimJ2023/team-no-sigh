...
/*
	...
	@Insert("INSERT INTO streaming_img "
			+ "VALUES (img_id_seq_test.nextval, "
			+ "#{videoThumbUrl}")
	*/
	
	//20240227 이지수 api-db 입력 테스트
	/*@Insert("INSERT INTO streaming_info(streaming_id, streaming_description)"
			+ "VALUES (streaming_id_test_seq.nextval, #{streaming_description}")
	void addVideoInfo(List<Ranking> videoRankingBean);*/
